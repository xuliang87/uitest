...
sap.ui.define([
		...
		return BaseController.extend("jekunauto.ui.erp.controller.Code", {
			...
			_loadCode: function (oData) {
				...
				if (!oSample) {
					this.router.myNavToWithoutHash("jekunauto.ui.erp.view.NotFound", "XML", false, { path: this._sId });
					return;
				}
			...
			createIndexFile : function(oData) {
				...
				var sRef = jQuery.sap.getModulePath("jekunauto.ui.erp.tmpl");
			...
			downloadMockFile : function(sFile) {
				...
				var sWrongPath = "test-resources/jekunauto/ui/erp/images/";
				var sCorrectPath = "https://openui5.hana.ondemand.com/test-resources/jekunauto/ui/erp/images/";
