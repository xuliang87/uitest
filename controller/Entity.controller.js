...
sap.ui.define([
		...
		"jekunauto/ui/erp/controller/util/EntityInfo",
		...
		return BaseController.extend("jekunauto.ui.erp.controller.Entity", {
			...
			_loadSample: function (oControlsData) {
				...
				if (this._sId !== sNewId) {
					...
					EntityInfo.getEntityDocuAsync(sNewId, oEntity && oEntity.namespace).then(function (oDoc) {
						...
						if (!oEntity && !oDoc) {
							this.router.myNavToWithoutHash("jekunauto.ui.erp.view.NotFound", "XML", false, {path: sNewId});
							return;
						}
