...
sap.ui.define([
		...
		return BaseController.extend("jekunauto.ui.erp.controller.ControlsMaster", {
			...
			*/
			...
			handleListSettings: function () {
				...
				if (!this._oVSDialog) {
					this._oVSDialog = sap.ui.xmlfragment(this.getView().getId(), "jekunauto.ui.erp.view.viewSettingsDialog", this);
			...
			handleSettings: function () {
				if (!this._oSettingsDialog) {
					this._oSettingsDialog = new sap.ui.xmlfragment("jekunauto.ui.erp.view.appSettingsDialog", this);
